...
const items = [
  { label: "Beranda", to: "/student", icon: Home },
  { label: "Kuis", to: "/student/quizzes", icon: Brain },
  { label: "Kemajuan", to: "/student/progress", icon: BarChart3 },
  { label: "Pencapaian", to: "/student/rewards", icon: Trophy },
    ...
    >
      ...
      <div className="mt-auto rounded-[20px] border border-[#EEE7FF] bg-gradient-to-br from-[#F7F0FF] to-white px-[14px] py-[14px]">
        <div className="flex items-center gap-[10px]">
          ...
          <NotificationBell to="/student/notifications" size={24} />
        </div>
      </div>
    </aside>
  );
