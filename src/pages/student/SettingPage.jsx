      ...
      <div className="mx-auto min-h-screen w-full max-w-[460px] px-[14px] pb-[104px] pt-[49px]">
        ...
        <section className="mt-[16px] rounded-[18px] border border-[#E5E7EB] bg-white px-[18px] pb-[22px] pt-[18px] shadow-[0_8px_24px_rgba(0,0,0,0.03)] transition hover:-translate-y-[2px]">
          ...
          <div className="mt-[14px]">
            ...
            <div className="relative mt-[8px] rounded-[12px] border border-[#E5E7EB] bg-white focus-within:border-[#651DFF]">
              <div className="absolute left-[13px] top-[13px] text-[#6B7280]">
                <Gamepad2 size={18} />
              </div>
              ...
              <textarea
                ...
                className="h-[82px] w-full resize-none rounded-[12px] px-[13px] py-[11px] pl-[42px] text-[13px] font-medium outline-none"
              />
            </div>

            <p className="mt-[6px] text-[10px] font-medium leading-[1.3] text-[#9CA3AF]">
              Minat ini digunakan AI untuk membuat penjelasan yang lebih personal.
            </p>
          </div>
...
const Input = ({
  ...
  return (
    <div className="mt-[14px]">
      ...
      <div className="relative mt-[8px] h-[40px] rounded-[12px] border border-[#E5E7EB] bg-white transition focus-within:border-[#651DFF]">
  ...
  return (
    <div className="mt-[14px]">
      ...
      <select
        ...
        value={value}
        onChange={onChange}
        className="mt-[8px] h-[40px] w-full rounded-[12px] border border-[#E5E7EB] bg-white px-[13px] text-[13px] font-medium outline-none transition focus:border-[#651DFF]"
      >
        {options.map((item) => (
...
const PasswordInput = ({
  ...
  return (
    <div className="mt-[14px]">
      ...
      <div className="relative mt-[8px] h-[40px] rounded-[12px] border border-[#E5E7EB] transition focus-within:border-[#651DFF]">
        <input
